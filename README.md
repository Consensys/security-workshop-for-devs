...
# How To Not Get Rekt: Smart Contract Secure SDLC for Developers
  ...
  * [Part 3 - The Real Fun Begins](#part-3---the-real-fun-begins)
    + [Exercise 1 - Reentrancy](#exercise-1---reentrancy)
    + [Exercise 2 - Access Controls](#exercise-2---access-controls)
    + [Exercise 3 - Cheating on CTFs with Mythril](#exercise-3---cheating-on-ctfs-with-mythril)
    + [Exercise 4 - Continuous Integration with Github Projects](#exercise-4---continuous-integration-with-github-projects)
